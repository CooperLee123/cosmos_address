...
local keystore.
Use the --pubkey flag to genmno arbitrary public keys to the keystore for constructing
multisig transactions.

You can genmno a multisig key by passing the list of key names you want the public
...
`,
	...
	cmd.Flags().Bool(flagDryRun, false, "Perform action, but don't genmno key to local keystore")
